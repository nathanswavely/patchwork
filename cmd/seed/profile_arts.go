...
var artsUsers = []userDef{
	...
	{"kira.yamamoto@example.com", "kira-yamamoto", "Kira Yamamoto", "Bookbinder and paper artist. Runs workshops at the Creative Factory.", "member", 120},
...
var artsNodes = []nodeDef{
	...
	{
		name: "The Creative Factory", slug: "creative-factory",
		...
		website:          "https://creativefactory.example",
		links: []nodeLink{
			{URL: "https://creativefactory.example/tools", Label: "Tool Library"},
			{URL: "https://instagram.example/creativefactorylanc", Label: "Instagram"},
		},
	},
	{
...
var artsEvents = []eventDef{
	...
	// Creative Factory
	{"Intro to Laser Cutting", "Learn to design and cut with our Glowforge. Bring a simple design or use our templates. Materials provided.", "creative-factory", "The Creative Factory", 8, 2},
	{"Fix-It Clinic", "Bring your broken stuff — toasters, lamps, bikes, clothing. Volunteer fixers will help you repair instead of replace.", "creative-factory", "The Creative Factory", 15, 3},
...
var artsProposals = []proposalDef{
	...
	{"Open tool library to non-members", "Allow neighborhood residents to borrow hand tools with a $20/year library card. Power tools remain member-only.", "creative-factory", "open", "action", 4, 168},
...
var artsGovDocs = []govDocDef{
	...
	{"creative-factory", "Tool Library Rules", "Return tools within 7 days, clean and functional. Report any damage. No modifications to shared equipment. Consumables (sandpaper, drill bits) are replenished monthly — don't hoard. If you break it, tell us. Accidents happen; dishonesty gets your card revoked."},
...
var artsNotifications = []notifDef{
	...
	{20, "new_event", "New event: Fix-It Clinic", "Bring your broken stuff to the Creative Factory.", "/events", false},
	{24, "new_event", "New event: Beat Battle", "16 producers, one night at the Low End Lab.", "/events", false},
	{22, "membership_approved", "Welcome to Creative Factory", "Your membership at the Creative Factory is confirmed.", "/nodes/creative-factory", true},
}
