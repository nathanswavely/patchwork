...
- Any member can propose something by submitting a baste request.
...
- Any member can propose changes to this document through a baste request.
...
Existing admins may nominate any active member for an admin role. The nomination is posted as a baste request. The community has 7 days to discuss and vote. A majority of active members must approve.
...
- **Proposals**: Any member can submit a baste request for community decisions.
...
- **Over $500**: Requires a baste request and community vote.
...
If you disagree with the admin's resolution, you can escalate to a community review. The situation is presented (with identities protected where possible) as a baste request. The community votes on the resolution.
...
### 2.3 Removal
A council member can be removed by a supermajority vote of the full membership. A removal baste request requires signatures from at least 10% of active members to be considered.
...
Any member can propose an amendment to these bylaws or any governance document by submitting a baste request.
...
| Over $5,000 | Community vote (baste request) |

## Budgeting

The council proposes an annual budget as a baste request. The budget must be approved by a majority vote with 50% quorum. Mid-year budget amendments follow the same process.
...
If either party disagrees with the council's resolution, they may appeal to the full membership. The appeal is presented as a baste request with identities protected where possible. The community votes on the resolution.
