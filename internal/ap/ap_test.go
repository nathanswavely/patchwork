...
func TestNodeToActor(t *testing.T) {
	...
	if actor.ID != "https://arts.lancaster.example/ap/nodes/test-node-id" {
	...
	if actor.Inbox != "https://arts.lancaster.example/ap/nodes/test-node-id/inbox" {
...
func TestUserToActor(t *testing.T) {
	...
	actor := ap.UserToActor(user, "arts.lancaster.example")
	...
	if actor.URL != "https://arts.lancaster.example/users/jdoe" {
