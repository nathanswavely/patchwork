...
-- the durable identity (docs/adr/036). Extensible by design; only 'lining'
...
--
-- The lining is always public (docs/adr/036) — the one document ADR 035's
...
-- Personal discovery filter (docs/adr/036): hide amended-lining patches from
