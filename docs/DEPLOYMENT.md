...
The reference instance runs Namecheap DNS + [ImprovMX](https://improvmx.com)
free (inbound: root MX + SPF, a `hello@` alias → the admin's mailbox) +
Resend (outbound, as in recipe A). It works and costs nothing, but it's three accounts, and
